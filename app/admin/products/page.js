...
export default function AdminProductsPage() {
  ...
  const sampleImages = [
    { name: 'Implant', url: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&w=600&q=80' },
    { name: 'Niềng răng', url: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&w=600&q=80' },
    { name: 'Răng sứ', url: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=600&q=80' },
    { name: 'Tẩy trắng', url: 'https://images.unsplash.com/photo-1541604193435-22287d32c2c2?auto=format&fit=crop&w=600&q=80' }
  ];
  ...
  const handleSave = async (e) => {
    ...
    try {
      const fallbackImage = 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=600&q=80';
              ...
              <div className="adm-grid-2-1" style={{ alignItems: 'flex-start' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px dashed #cbd5e1', borderRadius: '8px', padding: '10px', background: '#f8fafc', minHeight: '110px' }}>
                  {form.thumbnail ? (
                    ...
                    <span style={{ fontSize: '11px', color: 'var(--admin-muted)', textAlign: 'center', lineHeight: '1.4' }}>Chưa có ảnh<br/>(Tự động thay bằng ảnh mặc định)</span>
                  )}
                </div>
              </div>
