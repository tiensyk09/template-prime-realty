    ...
    <div style={{ backgroundColor: '#f5f7fa', minHeight: '100vh', padding: '24px 0 60px' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '16px', display: 'flex', gap: '6px', alignItems: 'center' }}>
          ...
          <span>/</span>
          <span style={{ color: '#c9a24b', fontWeight: 600 }}>Giỏ hàng</span>
        </div>
        ...
        {items.length === 0 ? (
          <div style={{ background: '#fff', borderRadius: '16px', padding: '60px 20px', textAlign: 'center', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.02)' }}>
            ...
            <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#0d2a4d' }}>Giỏ hàng trống</h3>
            <p style={{ color: '#6b7280', fontSize: '14px', marginTop: '6px' }}>Bạn chưa chọn sản phẩm dịch vụ nào.</p>
            <Link
              href="/products"
              style={{ display: 'inline-block', marginTop: '20px', background: '#c9a24b', color: '#fff', border: 'none', padding: '12px 28px', borderRadius: '30px', fontWeight: 700, textDecoration: 'none' }}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '24px', alignItems: 'start' }} className="cart-page-layout">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  >
                    ...
                    <div className="lc-cart-item-actions">
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', border: '1.5px solid #cbd5e1', borderRadius: '8px', overflow: 'hidden', background: '#fff' }}>
                        ...
                        <span style={{ width: '32px', textAlign: 'center', fontSize: '13px', fontWeight: 600, color: '#0d2a4d' }}>
                          {item.quantity}
                        </span>
                        <button
                          onClick={() => updateQty(item.key, item.quantity + 1)}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <Link href="/products" style={{ color: '#c9a24b', fontWeight: 700, fontSize: '14px', textDecoration: 'none' }}>
                  ← Chọn thêm dịch vụ khác
                </Link>
                <button
                  onClick={clearCart}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }} className="cart-summary-column">
              ...
              <div style={{ background: '#fff', borderRadius: '16px', padding: '20px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.01)' }}>
                <h3 style={{ fontSize: '15px', fontWeight: 800, color: '#0d2a4d', margin: '0 0 12px 0' }}>
                  Mã Giảm Giá
                </h3>
                <form onSubmit={handleApplyCoupon} style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '6px',
                      border: 'none',
                      background: (appliedCoupon || !couponCode.trim()) ? '#cbd5e1' : '#c9a24b',
                      color: '#fff',
                      fontWeight: 700,
                      fontSize: '13px',
                      cursor: 'pointer'
                ...
                {appliedCoupon && (
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#f6f2e9', border: '1px solid #e2d3b3', padding: '8px 12px', borderRadius: '6px', marginTop: '12px' }}>
                    <span style={{ fontSize: '13px', color: '#a8863a', fontWeight: 600 }}>
              ...
              <div style={{ background: '#fff', borderRadius: '16px', padding: '20px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.01)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '14px', color: '#374151' }}>
                  ...
                  <p style={{ fontSize: '11.5px', color: '#6b7280', margin: 0, fontStyle: 'italic' }}>
                    * Miễn phí tư vấn và khảo sát nhu cầu bất động sản.
                  </p>
                  <div style={{ borderTop: '1px solid #f3f4f6', paddingTop: '12px', marginTop: '4px', display: 'flex', justifyContent: 'space-between', fontWeight: 800, fontSize: '15.5px', color: '#0d2a4d' }}>
                    <span>Tổng cộng</span>
