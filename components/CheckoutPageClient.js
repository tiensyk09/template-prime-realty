...
export default function CheckoutPageClient() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.name || !form.phone || !form.address) {
      setErrorMsg('Vui lòng điền đầy đủ họ tên, số điện thoại và địa chỉ liên hệ.');
      setLoading(false);
      return;
    }
  ...
  if (!hydrated) {
    return (
      <div style={{ backgroundColor: '#f5f7fa', minHeight: '100vh', padding: '100px 0', textAlign: 'center' }}>
  ...
  if (orderSuccess) {
    ...
    return (
      <div style={{ backgroundColor: '#f5f7fa', minHeight: '100vh', padding: '40px 0 80px' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', padding: '0 20px' }}>
          <div style={{ background: '#fff', borderRadius: '16px', padding: '32px', textAlign: 'center', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.02)' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 900, color: '#0d2a4d', margin: '0 0 8px 0' }}>
              Đặt Hàng Thành Công!
            </h2>
            ...
            {paymentInfo ? (
              ...
              <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '24px', margin: '0 auto 24px auto', textAlign: 'left' }}>
                <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#0d2a4d', margin: '0 0 16px 0', borderBottom: '1px solid #e2e8f0', paddingBottom: '10px', textAlign: 'center' }}>
                ...
                <div className="bank-info-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 160px', gap: '20px', alignItems: 'center' }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '14.5px', color: '#374151' }}>
                    ...
                    <div>Số tài khoản: <strong style={{ fontSize: '16px', color: '#c9a24b' }}>{paymentInfo.bankAccount || 'Đang tải...'}</strong></div>
              ...
              <div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '12px', padding: '20px', margin: '0 auto 24px auto', fontSize: '14.5px', textAlign: 'left', color: '#374151' }}>
                ...
                <p style={{ margin: '8px 0 0 0', lineHeight: '1.6' }}>
                  ✓ Đội ngũ Prime Realty sẽ liên hệ qua điện thoại với quý khách để xác nhận đơn hàng trước khi gửi đi.
                </p>
              </div>
            )}
            ...
            <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link
                href="/orders"
                style={{ display: 'block', padding: '12px 28px', borderRadius: '30px', background: '#c9a24b', color: '#fff', fontWeight: 700, textDecoration: 'none', fontSize: '14px' }}
              ...
              <Link
                href="/products"
                style={{ display: 'block', padding: '12px 28px', borderRadius: '30px', border: '1.5px solid #c9a24b', color: '#c9a24b', fontWeight: 700, textDecoration: 'none', fontSize: '14px', background: '#fff' }}
              >
                Tiếp tục mua hàng
              </Link>
            </div>
  ...
  return (
    <div style={{ backgroundColor: '#f5f7fa', minHeight: '100vh', padding: '24px 0 60px' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 20px' }}>
        ...
        <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '16px', display: 'flex', gap: '6px', alignItems: 'center' }}>
          ...
          <span>/</span>
          <span style={{ color: '#c9a24b', fontWeight: 600 }}>Đặt hàng</span>
        </div>

        <h1 style={{ fontSize: '22px', fontWeight: 900, color: '#0d2a4d', marginBottom: '20px' }}>
        ...
        <form onSubmit={handleSubmit} className="checkout-form-grid" style={{ alignItems: 'start' }}>
          ...
          <div style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', gap: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.01)' }} className="checkout-card-panel">
            <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#0d2a4d', margin: 0, borderBottom: '1px solid #f3f4f6', paddingBottom: '12px' }}>
              Thông Tin Nhận Hàng
            </h3>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Ghi chú về nhu cầu, thời gian xem nhà, yêu cầu riêng của bạn..."
              />
            </div>

            <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#0d2a4d', margin: '12px 0 0 0', borderBottom: '1px solid #f3f4f6', paddingBottom: '12px' }}>
              Phương Thức Thanh Toán
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px', border: '1.5px solid ' + (form.paymentMethod === 'cod' ? '#c9a24b' : '#cbd5e1'), borderRadius: '10px', cursor: 'pointer', background: form.paymentMethod === 'cod' ? '#f6f2e9' : '#fff', transition: 'all 0.15s' }}>
                <input
                  type="radio"
                  name="payment"
                  value="cod"
                ...
                />
                <div>
                  <strong style={{ color: '#0d2a4d', fontSize: '14px' }}>Thanh toán khi nhận hàng (COD)</strong>
                  <div style={{ fontSize: '12px', color: '#6b7280', marginTop: '2px' }}>Chuyên viên Prime Realty sẽ liên hệ xác nhận và tư vấn chi tiết.</div>
                </div>
              </label>
              <label style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '14px', border: '1.5px solid ' + (form.paymentMethod === 'bank' ? '#c9a24b' : '#cbd5e1'), borderRadius: '10px', cursor: 'pointer', background: form.paymentMethod === 'bank' ? '#f6f2e9' : '#fff', transition: 'all 0.15s' }}>
                <input
                  type="radio"
                  name="payment"
                  value="bank"
                ...
                />
                <div>
                  <strong style={{ color: '#0d2a4d', fontSize: '14px' }}>Chuyển khoản ngân hàng (Quét mã VietQR chuyển khoản nhanh)</strong>
          ...
          <div style={{ background: '#fff', borderRadius: '16px', padding: '24px', border: '1px solid #e5e7eb', boxShadow: '0 4px 20px rgba(0,0,0,0.01)' }} className="checkout-card-panel">
            <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#0d2a4d', margin: '0 0 16px 0', borderBottom: '1px solid #f3f4f6', paddingBottom: '10px' }}>
              Đơn Hàng Của Bạn
            </h3>
              ...
              {items.map((item) => (
                <div key={item.key} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <img
                      src={item.thumbnail || 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=400&q=80'}
                  ...
                  <div style={{ fontWeight: 700, color: '#c9a24b', marginLeft: '12px', flexShrink: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '14px', borderTop: '1px solid #f3f4f6', paddingTop: '16px' }}>
              ...
              {pricing.discount > 0 && (
                <div style={{ display: 'flex', justifyContent: 'space-between', color: '#a8863a' }}>
                  <span>Giảm giá</span>
              ...
              <div style={{ borderTop: '1px solid #f3f4f6', paddingTop: '12px', marginTop: '4px', display: 'flex', justifyContent: 'space-between', fontWeight: 800, fontSize: '15px', color: '#0d2a4d' }}>
